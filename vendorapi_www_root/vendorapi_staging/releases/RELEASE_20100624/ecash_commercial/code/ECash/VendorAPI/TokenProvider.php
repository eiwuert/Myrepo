...
class ECash_VendorAPI_TokenProvider implements VendorAPI_ITokenProvider
{
	...
	public function getTokens(VendorAPI_IApplication $application, $is_preview, $loan_amount = NULL)
	{
		...
		$app->login_id = $application->getLoginID();
		...
		//tribal
		$tribal_tokens = $application->getTribalTokens();
		$app->tribal_ip = $tribal_tokens["server_ip"];
		$app->tribal_response_date_time = $tribal_tokens["tribal_response_date_time"];

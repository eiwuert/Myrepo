...
class ECash_VendorAPI_Blackbox_FactorTrust_BureauInquiryObserver implements VendorAPI_Blackbox_FactorTrust_ICallObserver
{
	/**
	 * @var ECash_Factory
	 */
	...
	protected function getReasons(FactorTrust_UW_Result $result)
	{
		$reason_arr = array();

...
class ECash_VendorAPI_Driver extends VendorAPI_BasicDriver
{
	...
	protected function getGetTransactionsAction()
	{
		return new VendorAPI_Actions_GetTransactions(
			$this,
			$this->getFactory(),
			new ECash_VendorAPI_ApplicationFactory($this, $this->getFactory(), $this->getDatabase())
		);
	...
	{
		// Try and get the Tribal request class name from the ECash_Factory
		$class_name = $this->factory->getClassString('Tribal_Request');
		// Default to TSS_Tribal_Request if no valid request can be found in the factory
		if (!class_exists($class_name)) $class_name = 'TSS_Tribal_Request';

		return new $class_name(
			NULL,
			NULL,
			$this->getTribalCallType($loan_type_id)
		);
	}

	/**
	* Returns a TSS_Tribal_IResponse object.
	*
	...
	*/
	...
	{
		$class = 'Tribal_Responses_Perf';

		return $this->factory->getClass($class);
	}

	/**
	* Returns the call type for the Tribal call.
	*
	* @param int $loan_type_id
	* @return string
	*/
	...
	/**
	 * Returns a new FactorTrust_UW_IRequest object.
	 *
	 * @param int $loan_type_id
	...
	{
		// Try and get the FactorTrust request class name from the ECash_Factory
		$class_name = $this->factory->getClassString('FactorTrust_Request');
		// Default to TSS_DataX_Request if no valid request can be found in the factory
		if (!class_exists($class_name)) $class_name = 'FactorTrust_UW_Request';

		return new $class_name($inquiry, $store);
	}
	...
	public function getFactorTrustResponse($loan_type_id)
	{
		...
		{
			$class = 'FactorTrust_Responses_Perf';
		}
		return $this->factory->getClass($class);
	}

	/**
	 * Returns the call type for the FactorTrust call.
	 *
	 * @param int $loan_type_id
	 * @return string
	 */
	...
	/**
	 * Returns a new Clarity_UW_IRequest object.
	 *
	 * @param int $loan_type_id
	 * @return Clarity_UW_IRequest
	 */
	public function getClarityRequest($inquiry, $store, $loan_type_id)
	{
		// Try and get the Clarity request class name from the ECash_Factory
		$class_name = $this->factory->getClassString('Clarity_Request');
		// Default to TSS_DataX_Request if no valid request can be found in the factory
		if (!class_exists($class_name)) $class_name = 'Clarity_UW_Request';
	...
	public function getClarityResponse($loan_type_id)
	{
		...
		{
			$class = 'Clarity_Responses_Perf';
		}
		return $this->factory->getClass($class);
	}

	/**
	 * Returns the call type for the Clarity call.
	 *
	 * @param int $loan_type_id
	 * @return string
	 */
	...
	public function getDisagreeAction()
	{
		return new VendorAPI_Actions_Disagree(
			$this,
			 $this->getApplicationFactory()
		);
	}
	
	public function getEmailUsernameAction()
	{
		return new VendorAPI_Actions_EmailUsername(
			$this->getApplicationFactory(),
			new ECash_VendorAPI_Document(new ECash_Documents_Condor(), $this->getFactory()),
			$this,
			new ECash_VendorAPI_TokenProvider($this)
	...
	public function getEmailPasswordLinkAction()
	{
		return new VendorAPI_Actions_EmailPasswordLink(
			$this->getApplicationFactory(),
			new ECash_VendorAPI_Document(new ECash_Documents_Condor(), $this->getFactory()),
			$this,
			new ECash_VendorAPI_TokenProvider($this)
	...
	public function getMaxReactAmountAction()
	{
		return new VendorAPI_Actions_MaxReactAmount(
			$this,
			new VendorAPI_Actions_Validators_Post(),
			$this->getApplicationFactory(),
			new VendorAPI_CFE_RulesetFactory(new VendorAPI_CFE_Factory()),
	...
	{
		return new VendorAPI_Actions_Decline(
			$this,
			$this->getApplicationFactory()
		);
	}
	...
	public function getResetPasswordAction()
	{
		return new VendorAPI_Actions_ResetPassword(
			$this,
			new ECash_VendorAPI_ApplicationFactory($this, $this->getFactory(), $this->getDatabase())
		);
	}
	
	public function getLoginLockAction()
	{
		return new VendorAPI_Actions_LoginLock(
			$this,
			$this->getFactory(),
			$this->getApplicationFactory()
		);
	...
	public function getGetContactFieldsAction()
	{
		return new VendorAPI_Actions_GetContactFields(
			$this,
			$this->getApplicationFactory()
		);
	}
	
	public function getSetContactFieldsAction()
	{
		return new VendorAPI_Actions_SetContactFields(
			$this,
			$this->getApplicationFactory()
		);
	}

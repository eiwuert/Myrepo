...
class ECash_VendorAPI_Blackbox_Rule_Factory extends VendorAPI_Blackbox_Rule_Factory
{
	...
	{
		$observers = array(
			new ECash_VendorAPI_Blackbox_FactorTrust_BureauInquiryObserver(
				$this->driver->getFactory(),
				$this->config->call_context,
				$this->config->persistor,
				$this->driver->getInquiryClient()
		...
		$class_name = strtoupper($this->driver->getEnterprise())
			.'_VendorAPI_Blackbox_FactorTrust_AdverseActionObserver';
		...
		$class_name = strtoupper($this->driver->getEnterprise())
			.'_VendorAPI_Blackbox_FactorTrust_AutoFundObserver';
	...
	{
		$observers = array(
			new ECash_VendorAPI_Blackbox_Clarity_BureauInquiryObserver(
				$this->driver->getFactory(),
				$this->config->call_context,
				$this->config->persistor,
				$this->driver->getInquiryClient()
		...
		$class_name = strtoupper($this->driver->getEnterprise())
			.'_VendorAPI_Blackbox_Clarity_AdverseActionObserver';
		...
		$class_name = strtoupper($this->driver->getEnterprise())
			.'_VendorAPI_Blackbox_Clarity_AutoFundObserver';

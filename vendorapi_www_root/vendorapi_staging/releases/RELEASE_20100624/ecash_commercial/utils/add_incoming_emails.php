...
$test_addresses = array(
	'customerservice@someloancompany.com',
	'collections@someloancompany.com',
);

// instantiate the prpc_client
$condor = new PRPC_Client('prpc://username:password@rc.condor.4.edataserver.com/condor_api.php');

<?php
	...
	class ECash_NightlyEvent_ExpireWatchedAccounts extends ECash_Nightly_Event
	{
		...
		private function Expire_Watched_Accounts()
		{
			...
			$mysql_query = "EXECECUTE sp_commercial_has_watch_flag";
			...
			ECash_DB_Util::generateTempTableFromArray($this->db, 'temp_has_watch_flag', $mysql_results, $columns, 'application_id');

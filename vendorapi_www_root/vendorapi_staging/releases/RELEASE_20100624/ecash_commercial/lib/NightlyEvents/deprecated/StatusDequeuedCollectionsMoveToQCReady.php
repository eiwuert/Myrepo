 ...
 */
	class ECash_NightlyEvent_StatusDequeuedCollectionsMoveToQCReady extends ECash_Nightly_Event
	{
		...
		private function Status_Dequeued_Collections_Move_To_QC_Ready()
		{
			...
			$status_list = "'dequeued::contact::collections::customer::*root','follow_up::contact::collections::customer::*root','queued::contact::collections::customer::*root','return::quickcheck::collections::customer::*root'";

			/* set up the application service */
			$mysql_query = 'EXECECUTE sp_commercial_nightly_status_dequeued_to_qcready ("'.$status_list.'","IN");';
			...
			ECash_DB_Util::generateTempTableFromArray($this->db, 'temp_move_in_qaready', $mysql_results, $columns, 'application_id');
			...
			/* set up the application service */
			$mysql_query = 'EXECECUTE sp_commercial_nightly_status_dequeued_to_qcready ("'.$status_list.'","NOT IN");';
			...
			ECash_DB_Util::generateTempTableFromArray($this->db, 'temp_move_notin_qaready', $mysql_results, $columns, 'application_id');

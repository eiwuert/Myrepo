...
class Achbatch_Detail_Report extends Report_Parent
{
	...
	public function __construct(ECash_Transport $transport, $module_name)
	{
		...
		$this->report_title = "ACH Batch Detail Report";
...
<tr><th>ACH Batch ID</th><th>Total # Credit</th><th>Total $ Credit</th><th>Total # Debit</th><th>Total $ Debit</th></tr>\n";
		...
		else
		{
			...
			$output         .= "ACH Batch ID\tTotal # Credit\tTotal $ Credit\tTotal # Debit\tTotal $ Debit\n";
			foreach($summary as $batch_id => $totals)
			{

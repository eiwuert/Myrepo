...
/*
	...
	private function FormatFloatDiv($apparr,$data,$dname)
	{
		...
		if(count($apparr))
		{
			...
			$download_link = "<a href=\'/?module=reporting&mode=internal_recovery&action=download_report&detailed_view=$dname&detailed_date={$save_date}\'>Download Detailed Displayed Data to Excel</a>";
			$appstr .= "</table>";

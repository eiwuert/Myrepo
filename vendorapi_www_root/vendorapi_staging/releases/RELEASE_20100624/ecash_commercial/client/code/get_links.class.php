...
class Get_Links
{
	...
	{
		$result = '<a href="#" onClick="javascript:SetDisplay(0,0,9,\'edit\', \'' . $this->mode . '_buttons\');">Edit Payment Card Information &nbsp;</a>';
	...
	{
		$result = '<a href="#" onClick="javascript:SetDisplay(0,0,11,\'edit\', \'' . $this->mode . '_buttons\');">Payment Card Information &nbsp;</a>';

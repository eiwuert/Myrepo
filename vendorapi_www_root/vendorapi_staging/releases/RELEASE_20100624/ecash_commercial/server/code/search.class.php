...
class Search
{
	...
	protected $module;
	protected $application_service_fields = array('ssn_last4', 'application_id', 'name_first', 'name_last', 'social_security_number', 'email', 'phone', 'zip_code', 'bank_account', 'customer_id', 'ip_address');

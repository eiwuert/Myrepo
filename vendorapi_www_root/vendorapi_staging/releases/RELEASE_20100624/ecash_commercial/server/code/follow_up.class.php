...
class Follow_Up
{
	...
	static public function Create_Follow_Up($application_id, $follow_up_type, $follow_up_time, $agent_id = 0, $company_id = NULL, $comment = NULL, $date_expiration = NULL, $fire_cfe = true)
	{
		$db = ECash::getMasterDb();
	...
	static public function createCollectionsFollowUp($application_id, $follow_up_time, $agent_id, $company_id, $comment, $date_expiration, $affiliation_reason, $fire_cfe = true)
	{
		...
		if(!empty($comment))
		{
			$application->getComments()->add("F: $comment", $agent_id, ECash_Application_Comments::TYPE_FOLLOWUP, ECash_Application_Comments::SOURCE_LOAN_AGENT);
		}

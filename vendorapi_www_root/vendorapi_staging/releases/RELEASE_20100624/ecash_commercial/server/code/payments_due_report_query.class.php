...
class Payments_Due_Report_Query extends Base_Report_Query
{
	...
	public function Fetch_Payments_Due_Data($start_date, $end_date, $loan_type, $company_id, $mode = null, $force_save = false)
	{
		...
		$data = $this->Fetch_Current_Data($start_date, $end_date, $loan_type, $company_id, $timer);
	...
	public function Fetch_Current_Data($start_date, $end_date, $loan_type, $company_id, $timer)
	{
		$this->timer->startTimer( $timer );

...
$query = "select
 b.application_id, b.bureau_inquiry".$is_failed_str."_id,
...
foreach($rows as $row) {
        try{
            if ($row['received_package'] <> '') {
                  ...
                  $dataxResponse->parseXML($row['received_package']);
                  ...
                  $dataxResponse->update_bureau_xml_fields($db, $row['application_id'], $bureau_inquiry_id, $bureau_inquiry_failed_id);
            }
        }
        catch(Exception $e) {

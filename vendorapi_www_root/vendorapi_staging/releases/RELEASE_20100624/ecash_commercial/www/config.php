...
if (EXECUTION_MODE == 'LIVE')
{
	...
	defineIf('FT_URL', 'https://www.factortrust.com/WebServices/LendProtectRequest.aspx?version=2.4');
	defineIf('CL_URL', 'https://secure.clarityservices.com/inquiries/create_from_xml');
	//defineIf('CL_URL', 'https://secure.clarityservices.com/inquiries/create_from_xml');
}
else
{
	defineIf('DATAX_URL', 'https://rc.verihub.com/datax/');
	defineIf('FT_URL', 'https://stage.factortrust.com/WebServices/LendProtectRequest.aspx');
	defineIf('CL_URL', 'https://secure.clarityservices.com/inquiries/create_from_xml_test');
}

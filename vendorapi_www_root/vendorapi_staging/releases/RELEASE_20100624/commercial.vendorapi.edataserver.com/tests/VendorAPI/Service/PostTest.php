...
class VendorAPI_Service_PostTest extends PHPUnit_Framework_TestCase
{
	protected $_action;
	protected $_driver;
	protected $_state;
	...
	protected function setUp()
	{
		...
		$this->_action = $this->getMock('VendorAPI_Actions_Post', array(
				'execute',
				'getLoanAmountCalculator',
				'getLoanTypeId',
				'writeDataXCallsToState',
				'saveDataInState',
				'saveDataInStatePart',
				'getLoanTypeName',
				'getRuleSetId',
				'getApplciationService'
			), array(), '', FALSE);
	...
	{
		$response = $this->_service->post(array());

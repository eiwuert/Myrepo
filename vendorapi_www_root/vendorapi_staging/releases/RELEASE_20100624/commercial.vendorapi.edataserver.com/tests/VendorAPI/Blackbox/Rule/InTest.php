...
/**
 * Unit tests for the VendorAPI_Blackbox_Rule_In object
 * @author Andrew Minerd <andrew.minerd@sellingsource.com>
 */
class VendorAPI_Blackbox_Rule_InTest extends PHPUnit_Framework_TestCase
{
	protected $event_log = "";
	...
	public function testInExists()
	{
		...
		$rule = $this->getMock('VendorAPI_Blackbox_Rule_In', array('hitStat', 'hitEvent'), array($this->event_log));
	...
	public function testNotArray()
	{
		...
		$rule = $this->getMock('VendorAPI_Blackbox_Rule_In', array('onError', 'hitEvent', 'hitStat'), array($this->event_log));

<?php
/**
 * PHPUnit test class for the VendorAPI_Blackbox_Rule_LessThanEquals class.
 *
 * @author Andrew Minerd <andrew.minerd@sellingsource.com>
 */
class VendorAPI_Blackbox_Rule_LessThanEqualsTest extends PHPUnit_Framework_TestCase
{
	protected $event_log = "";
	...
	public function testLessThanEquals($data_value, $rule_value, $expected)
	{
		...
		$rule = $this->getMock('OLPBlackbox_Rule_LessThanEquals', array('hitStat', 'hitEvent'), array($this->event_log));

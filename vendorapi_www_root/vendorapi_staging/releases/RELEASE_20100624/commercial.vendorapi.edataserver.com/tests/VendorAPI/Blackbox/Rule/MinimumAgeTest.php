 ...
 */
class VendorAPI_Blackbox_Rule_MinimumAgeTest extends PHPUnit_Framework_TestCase
{
	protected $event_log = "";
	...
	public function testGreaterThanAge()
	{
		...
		$rule = $this->getMock('VendorAPI_Blackbox_Rule_MinimumAge', array('hitStat', 'hitEvent'), array($this->event_log));
	...
	public function testNoDobException()
	{
		...
		$rule = $this->getMock('VendorAPI_Blackbox_Rule_MinimumAge', array('onSkip', 'hitEvent', 'hitStat'), array($this->event_log));
	...
	public function testAgeException()
	{
		...
		$rule = $this->getMock('VendorAPI_Blackbox_Rule_MinimumAge', array('onError', 'hitEvent', 'hitStat'), array($this->event_log));

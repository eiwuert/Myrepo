 ...
 */
class VendorAPI_Blackbox_Rule_GreaterThanTest extends PHPUnit_Framework_TestCase
{
	protected $event_log = "";
	...
	public function testGreater()
	{
		...
		$rule = $this->getMock('VendorAPI_Blackbox_Rule_GreaterThan', array('hitStat', 'hitEvent'), array($this->event_log));

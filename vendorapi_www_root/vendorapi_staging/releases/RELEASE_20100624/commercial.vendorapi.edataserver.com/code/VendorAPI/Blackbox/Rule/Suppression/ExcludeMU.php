...
/**
 * Exclude, campaign specific, suppression list rule to exclude matches to the multiple suppression list
 *
 */
class VendorAPI_Blackbox_Rule_Suppression_ExcludeMU extends VendorAPI_Blackbox_Rule
{
	/**
	...
	{
		return "LIST_Exclude_MU_".strtoupper($this->list_name);
	}

 ...
 * a failed Factor Trust call, this immediately hits the adverse action stat.
 *
 * @author Andrew Minerd <andrew.minerd@sellingsource.com>
 */
abstract class VendorAPI_Blackbox_FactorTrust_AdverseActionObserver implements VendorAPI_Blackbox_FactorTrust_ICallObserver
{
	/**
	 * @var string
	 */
	 ...
	 * @return void
	 */
	public function onCall(VendorAPI_Blackbox_Rule_FactorTrust $caller, FactorTrust_UW_Result $result, $state, VendorAPI_Blackbox_Data $data)
	{
		if (!$result->isValid())
		{
	 ...
	 * @return string|null
	 */
	abstract protected function getAdverseAction(FactorTrust_UW_Result $result);
	 ...
	 * @return string|null
	 */
	protected function findFirstFailedBucket(FactorTrust_UW_IPerformanceResponse $response)
	{

 ...
 */
abstract class VendorAPI_Blackbox_Clarity_AdverseActionObserver implements VendorAPI_Blackbox_Clarity_ICallObserver
{
	/**
	 * @var string
	 */
	 ...
	 * @return string|null
	 */
	abstract protected function getAdverseAction(Clarity_UW_Result $result);
	 ...
	 * @return string|null
	 */
	protected function findFirstFailedBucket(Clarity_UW_IPerformanceResponse $response)
	{

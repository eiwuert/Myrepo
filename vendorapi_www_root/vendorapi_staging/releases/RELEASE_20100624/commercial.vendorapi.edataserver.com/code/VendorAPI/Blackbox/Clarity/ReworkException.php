 ...
 */
class VendorAPI_Blackbox_Clarity_ReworkException extends Exception
{
	/**
	 * The Clarity response that triggered the rework condition
	 ...
	 * @param array $info Clarity call that failed
	 *
	 * @return void
	 */
	...
	/**
	 * The Clarity response that triggered the rework
	 * @return string
	 */

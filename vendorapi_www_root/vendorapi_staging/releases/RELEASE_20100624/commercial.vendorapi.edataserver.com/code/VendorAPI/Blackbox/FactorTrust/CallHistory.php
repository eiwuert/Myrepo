...
/**
 * Stores FactorTrust call results
 *
 * @author Andrew Minerd <andrew.minerd@sellingsource.com>
 */
class VendorAPI_Blackbox_FactorTrust_CallHistory implements IteratorAggregate
{
	/**
	 * @var array
	 */
	 ...
	 * @return void
	 */
	public function addResult(FactorTrust_UW_Result $result)
	{
	 ...
	 *
	 * @param string $call
	 * @return FactorTrust_UW_Result|null
	 */

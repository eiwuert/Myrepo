...
/**
 * Stores DataX call results
 *
 * @author Andrew Minerd <andrew.minerd@sellingsource.com>
 */
class VendorAPI_Blackbox_DataX_CallHistory implements IteratorAggregate
{
	/**
	 * @var array
	 */
	 ...
	 * @return void
	 */
	public function addResult(TSS_DataX_Result $result)
	{

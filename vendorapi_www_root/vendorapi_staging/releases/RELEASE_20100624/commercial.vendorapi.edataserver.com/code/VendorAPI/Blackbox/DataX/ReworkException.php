 ...
 */
class VendorAPI_Blackbox_DataX_ReworkException extends Exception
{
	/**
	 * The DataX response that triggered the rework condition
	 ...
	 * @param array $info DataX call that failed
	 *
	 * @return void
	 */
	...
	/**
	 * The DataX response that triggered the rework
	 * @return string
	 */

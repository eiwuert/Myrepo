...
class VendorAPI_Actions_Decline extends VendorAPI_Actions_Base
{
	...
	{		
		...
		try
		{
			$application->updateStatus("confirm_declined::prospect::*root", $this->getCallContext()->getApiAgentId());

<?php
	...
	class ECash_Transactions_Schedule extends Object_1 implements IteratorAggregate, Countable
	{
		...
		{
			return $this->data->getScheduledPayments($this->application->getId());
		}
		 ...
		 * @return stdClass
		 */
		public function getScheduledPaymentsLeft()
		{
			return $this->data->getScheduledPaymentsLeft($this->application->getId());
		}

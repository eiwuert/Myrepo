...
class ECash_Qualify implements ECash_IQualify
{
	 ...
	 * @return int
	 */
	protected function getNextValidDay($date, $direct_deposit)
	{
	 ...
	 * @return bool
	 */
	protected function checkGracePeriod($due_date, $fund_date, $is_react = false)
	{
	...
	public function getGracePeriodDate($date, $is_react = false)
	{
		...
		if (array_key_exists('grace_period', $this->business_rules))
		{

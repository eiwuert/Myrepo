		...
		'batch_reports' => array(
			...
			'reports' => array(
				...
				'achbatch_detail' => array(
											'name' 	=> 'ACH Batch Detail',
											'link'  => '/?module=reporting&mode=achbatch_detail',
											'desc'	=> Gen_Report_Desc("Displays individual ACH Batch records for a date range.",
														array(	"Date Range"),
													    array( 'Date',  'Batch ID', 'ACH Date', 'Application ID',
															  'First Name', 'Last Name', 'ABA #', 'ACH Status',
															  'Amount', 'Return Code', 'Return Date' ) )
									),
				'batch_review' => array(
											'name' 	=> 'Batch Review',

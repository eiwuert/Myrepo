...
class SourcePro_Entity_Attribute_Field_Stamp extends SourcePro_Entity_Attribute_Field_Base
{
	...
	*/
	function __construct ($name, $column = NULL, $value = NULL, $type = NULL, $role = NULL, $min = NULL, $max = NULL)
	{
		parent::__construct($name, $column, $value, $type, $role, $min, $max);
	}

...
require_once( DIR_LIB . 'ecommlink/ecommlink_client_data.php' );


class Ecommlink_Client
{
	const RUN_MODE_MIN                       = 1;
	const RUN_MODE_LIVE                      = 1;    
	const RUN_MODE_TEST                      = 2;    
	const RUN_MODE_NO_CALL                   = 3;
	const RUN_MODE_TEST_FCP                  = 4;    
	const RUN_MODE_LIVE_FCP                  = 5;    
	const RUN_MODE_MAX                       = 5;
	
	const ECOMMLINK_URL_TEST = ''; // Used for testing.
	// const ECOMMLINK_URL_LIVE = '';       // LIVE processing. Works same as cashlynk.com.
	const ECOMMLINK_URL_LIVE = '';            // LIVE processing. Works same as cashlynkMC.com
	const NO_CALL_TEXT      = 'Ecommlink_Client: NO URL Because run_mode = NO_CALL_TEXT';    // For debugging, use this text as the response from RBS Lynk.
	...
	private $ecommlink_client_data;   // holds an instantiated Ecommlink_Client_Data object.
	...
	private $raw_data_sent;           // holds the raw data that was sent to Ecommlink.
	...
	public function Set_Operating_Mode( $mode )
	{
		...
		switch ( $this->run_mode )
		{
			case self::RUN_MODE_TEST:
				$this->Set_Required_Login_Info('114', 'webapi114', 'password');
			...
			case self::RUN_MODE_LIVE:
				$this->Set_Required_Login_Info('306', 'webapi306', 'password');      // This password worked better!  (2005.09.22)
			...
			case self::RUN_MODE_TEST_FCP:
				$this->Set_Required_Login_Info('110', 'Webapi110', 'password');  // new from Lee Butler 2006.01.17
			...
			case self::RUN_MODE_LIVE_FCP:
				$this->Set_Required_Login_Info('250', 'Webapi250', 'password');
	...
	public function Set_Required_Login_Info( $cid = '114', $cusr = 'webapi114', $cpwd = 'password' )
	{

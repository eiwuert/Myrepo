...
// +----------------------------------------------------------------------+
//
// $Id: Client.php 3271 2004-09-17 16:49:26Z rodricg $
//
 ...
 *
 * @access   public
 * @version  $Id: Client.php 3271 2004-09-17 16:49:26Z rodricg $
 * @package  SOAP::Client
...
class SOAP_Client extends SOAP_Base
{
    ...
    */
    ...
    function &call($method, &$params, $namespace = false, $soapAction = false)
    {
		...
		$rv =& $this->__parse($this->xml, $this->__result_encoding,$this->__attachments);
        return $rv;
    }
    ...
    */
    ...
    function &__parse(&$response, $encoding, &$attachments)
    {
		...
		$rv =& $this->__decodeResponse($return);
        return $rv;
    }

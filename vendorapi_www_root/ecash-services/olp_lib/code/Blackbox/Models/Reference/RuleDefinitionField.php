<?php
/**
 * Reference model for the rule_definition table for fields.
 *
 * @author Ryan Murphy <ryan.murphy@sellingsource.com>
 */
class Blackbox_Models_Reference_RuleDefinitionField extends Blackbox_Models_Reference_Model
{
	/**

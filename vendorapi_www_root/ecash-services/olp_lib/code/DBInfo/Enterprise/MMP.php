<?php
/**
 * Database connection information for the MMP eCash companies.
 *
 * @author Adam Englander <adam.englander@sellingsource.com>
 */
class DBInfo_Enterprise_MMP
{
	/**
	...
	public static function getDBInfo($name_short, $mode)
	{
		...
		$server = $db_config->getLegacyDatabaseConfig('enterprise/commercial/mmp', $mode);

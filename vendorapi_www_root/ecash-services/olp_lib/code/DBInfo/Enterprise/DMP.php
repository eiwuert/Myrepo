<?php
/**
 * Database connection information for the DMP eCash companies.
 *
 * @author Adam Englander <adam.englander@sellingsource.com>
 */
class DBInfo_Enterprise_DMP
{
	/**
	...
	public static function getDBInfo($name_short, $mode)
	{
		...
		$server = $db_config->getLegacyDatabaseConfig('enterprise/commercial/dmp', $mode);

<?php
/**
 * Database connection information for the HMS eCash companies.
 *
 * @author Adam Englander <adam.englander@sellingsource.com>
 */
class DBInfo_Enterprise_HMS
{
	/**
	...
	public static function getDBInfo($name_short, $mode)
	{
		...
		$server = $db_config->getLegacyDatabaseConfig('enterprise/commercial/hms', $mode);

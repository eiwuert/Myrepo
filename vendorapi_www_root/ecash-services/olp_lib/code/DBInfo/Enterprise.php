...
class DBInfo_Enterprise
{
	...
	public static function getDBInfo($property_short,$mode)
	{
		...
		// QEasy
		elseif (EnterpriseData::isCompanyProperty(EnterpriseData::COMPANY_QEASY, $property_short))
		{
			$db_info = DBInfo_Enterprise_QEasy::getDBInfo($property_short, $mode);
		}
		// HMS
		elseif (EnterpriseData::isCompanyProperty(EnterpriseData::COMPANY_HMS, $property_short))
		{
			$db_info = DBInfo_Enterprise_HMS::getDBInfo($property_short, $mode);
		}
		// OPM
		elseif (EnterpriseData::isCompanyProperty(EnterpriseData::COMPANY_OPM, $property_short))
		{
			$db_info = DBInfo_Enterprise_OPM::getDBInfo($property_short, $mode);
		}
		// DMP
		elseif (EnterpriseData::isCompanyProperty(EnterpriseData::COMPANY_DMP, $property_short))
		{
			$db_info = DBInfo_Enterprise_DMP::getDBInfo($property_short, $mode);
		}
		// MMP
		elseif (EnterpriseData::isCompanyProperty(EnterpriseData::COMPANY_MMP, $property_short))
		{
			$db_info = DBInfo_Enterprise_MMP::getDBInfo($property_short, $mode);
		}
		// CLK
		else
		{

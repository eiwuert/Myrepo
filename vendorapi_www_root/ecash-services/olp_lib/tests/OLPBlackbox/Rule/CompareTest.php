...
/**
 * Unit tests for the OLPBlackbox_Rule_Compare rule
 * @author Matt Piper <matt.piper@sellingsource.com>
 */
class OLPBlackbox_Rule_CompareTest extends PHPUnit_Framework_TestCase
{
	/**
	...
	public function testCompareTwoSame()
	{
		...
		$rule = $this->getMock('OLPBlackbox_Rule_Compare', array('hitStat', 'hitEvent'));
	...
	public function testNotArrayDoesntExist()
	{
		...
		$rule = $this->getMock('OLPBlackbox_Rule_Compare', array('onSkip', 'hitStat', 'hitEvent'));
	...
	public function testNotArrayExists()
	{
		...
		$rule = $this->getMock('OLPBlackbox_Rule_Compare', array('onError', 'hitStat', 'hitEvent'));
	...
	public function testInvalidArray()
	{
		...
		$rule->expects($this->once())->method('onError');
		$rule->setupRule(array(
					OLPBlackbox_Rule::PARAM_FIELD => array('param1'),
					));

 ...
 */
class OLPBlackbox_Rule_MultiCampaignRecurTest extends PHPUnit_Extensions_Database_TestCase
{
	const FAIL_SSN = '800991111';
	const FAIL_EMAIL = '2@tssmasterd.com';
	const PASS_SSN = '800991113';
	const PASS_EMAIL = '1@tssmasterd.com';
	...
	public function setup()
	{
		...
		$this->_rule = $this->getMock('FakeMultiCampaignRecur',
...
class FakeMultiCampaignRecur extends OLPBlackbox_Rule_MultiCampaignRecur
{

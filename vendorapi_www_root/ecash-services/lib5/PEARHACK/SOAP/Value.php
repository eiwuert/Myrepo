...
// +----------------------------------------------------------------------+
//
// $Id: Value.php 3271 2004-09-17 16:49:26Z rodricg $
//
...
*
* @access public
* @version $Id: Value.php 3271 2004-09-17 16:49:26Z rodricg $
* @package SOAP::Client
...
class SOAP_Value
{
    ...
    */
    ...
    {
		$rv =& $serializer->_serializeValue($this->value, $this->name, $this->type, $this->namespace, $this->type_namespace, $this->options, $this->attributes, $this->arrayType);
        return $rv;
    }
}

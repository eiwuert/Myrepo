...
class CM_Response {
	...
	/**
	 * Indicates if the response contains errors. If it does,
	 * the errors can be obtained with {@link #getErrors()}.
	 * @return boolean
	 */
	...
	/**
	 * Indicates if the application was sold successfully.
	 * @return boolean
	 */
	public function isSuccess() {
		return ($this->getPage() == 'app_completed');
	}

	...
	public function __construct($mode)
	{
		...
		switch ($mode)
		{
			case "LIVE":
				...
				$this->db_config["OLP"] = array("host" => "olpslave.internal.clkonline.com","port" => 3306, "user" => "sellingsource", "password" => "password", "db" => "olp");
				$this->db_config["CONDOR"]  = array("host" => "writer.condor.ept.tss","port" => 3306, "user" => "condor", "password" => "password", "db" => "condor");
				$this->db_config["LDB"]  = array("host" => "reader.ecash3clk.ept.tss","port" => 3306, "user" => "ecash", "password" => "password", "db" => "ldb");
				break;
			case "RC";
				DEFINE('CONDOR_SERVER' , 'prpc://condor.3.edataserver.com.gambit.tss:8080/');
				$this->db_config["OLP"] = array("host" => "rc: olpslave.clkonline.com","port" => 3306, "user" => "sellingsource", "password" => "password", "db" => "rc_olp");
				$this->db_config["CONDOR"] = array("host" => "db101.clkonline.com","port" => 3308, "user" => "condor", "password" => "password", "db" => "condor");
				$this->db_config["LDB"] = array("host" => "db1.clkonline.com","port" => 3307, "user" => "ecash", "password" => "password", "db" => "ldb");
				break;
		}

...
function Fetch_QC_Returns_File($server, $date, $overwrite = true)
{
	...
	$return_code = eCash_Config::getInstance()->QC_RETURN_CODE;
...
function Main()
{
	...
	catch (Exception $e) 
	{
		...
		{
			$recipients = 'brian.ronald@sellingsource.com, george.smoot@sellingsource.com, andy.roberts@sellingsource.com, mike.lively@sellingsource.com';
		}

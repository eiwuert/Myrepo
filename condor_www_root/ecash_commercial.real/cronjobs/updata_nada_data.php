...
function Main($argv)
{
	...
	$temp_dir = eCash_Config::getInstance()->NADA_TEMP_DIR;
	$backup_dir = eCash_Config::getInstance()->NADA_BACKUP_DIR;
	...
	$host   = eCash_Config::getInstance()->DB_HOST;
	$user   = eCash_Config::getInstance()->DB_USER;
	$pass   = eCash_Config::getInstance()->DB_PASS;
	$name   = eCash_Config::getInstance()->DB_NAME;
	$port   = eCash_Config::getInstance()->DB_PORT;
	$socket = eCash_Config::getInstance()->DB_SOCKET;
	$cache  = eCash_Config::getInstance()->DB_CACHE;

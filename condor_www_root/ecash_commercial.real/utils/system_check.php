...
$tests = array(
	...
	'Database Information' => array(
		...
		'Schema' => eCash_Config::getInstance()->DB_NAME,
		'User' => eCash_Config::getInstance()->DB_USER,
		'Port' => eCash_Config::getInstance()->DB_PORT
		),
	'ACH Information' => array(
		'Batch Server' => eCash_Config::getInstance()->ACH_BATCH_SERVER,
		'Server Port' => eCash_Config::getInstance()->ACH_BATCH_SERVER_PORT
		),

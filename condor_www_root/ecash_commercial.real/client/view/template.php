...
<html>
<head>
<title><?php echo TITLE; ?><?php echo " - " . ECash::getTransport()->login . " - " . ECash::getTransport()->company; ?></title>
...
{
	$use_archive = eCash_Config::getInstance()->MULTI_COMPANY_INCLUDE_ARCHIVE;
...
$any_values = FALSE;
if(eCash_Config::getInstance()->SHOW_SUMMARY_BAR !== FALSE)
{

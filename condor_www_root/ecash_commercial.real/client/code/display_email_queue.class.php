		...
		else
		{
			...
			?>
				...
				<tr>
					...
					<a href="/show.php?archive_id=<?=$this->data->email_queue_record->archive_id?>&part_id=<?=$attachment->part_id?>">
			...
			foreach ($documents as $id => $document)
			{
					...
					&& $document->active_status == 'active')
				{
					...
					$html .= '<tr><td class="' . $row_class . '"><a target="_blank" href="/document_preview.php?application_id=' 
						  . $this->data->email_queue_record->application_id . '&document_id=' . $id . '">' . $document->description 

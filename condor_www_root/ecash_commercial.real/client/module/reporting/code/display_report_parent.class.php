...
abstract class Report_Parent implements Display_Module
{
	...
	*/
	...
	public function __construct(ECash_Transport $transport, $module_name)
	{
		...
		$this->product_type = eCash_Config::getInstance()->PRODUCT_TYPE?eCash_Config::getInstance()->PRODUCT_TYPE:'Loan';
	...
	protected function Get_Form_Options_HTML(stdClass &$substitutions)
	{
		...
		function ReportCalendar(target, x, y, has_max_end, days_forward_max)
		{
			...
			{
				var cal = new Calendar(true, null, selectHand, closeHandler);
				calendar = cal;
...
//				 Never before funding date
		...
		if( $this->loan_type === true )
		{
			...
			$substitutions->loan_type_select_list  = '<span>'. $this->product_type .' Type : </span><span><select name="loan_type" size="1" style="width:auto;"></span>';
...
while(document.getElementById('scrollable_tbody_' + company_counter))
{
	...
	{	
			...
			$pulldowndata = array(
				'Active' => array( 20 ),
				'Additional' => array( 153 ),
				'Agree' => array( 5 ),
				'Agree (Preact)' => array( 142 ),
				'Amortization' => array( 145 ),
				'Applicant' => array( 101 ),
				'Approved' => array( 11, 10 ),
				'Approved (Preact)' => array( 141 ),
				'Approved Followup' => array( 14 ),
				'Arrangements' => array( 117 ),
				'Arrangements Failed' => array( 126 ),
				'Arrangements Hold' => array( 127 ),
				'Bankruptcy' => array( 118 ),
				'Bankruptcy Notification' => array( 128, 129, 130 ),
				'Bankruptcy Verified' => array( 131 ),
				//'Cashline' => array( 104, 21 ), // CLK status
				'Collections' => array( 110 ),
				'Collections (Dequeued)' => array( 138 ),
				'Collections Contact' => array( 132, 134 ),
				'Collections New' => array( 137 ),
				'Confirmed' => array( 8, 9 ),
				'Confirmed Followup' => array( 13 ),
				'Contact' => array( 119 ),
				'Contact Followup' => array( 133 ),
				//'Conversion Queued' => array( 115 ), // CLK status
				//'Customer' => array( 102 ), // CLK status
				'Denied' => array( 18 ),
				'Duplicate' => array( 12 ),
				//'External Collections' => array( 103 ), // CLK status
				'Fraud' => array( 105 ),
				'Fraud Confirmed' => array( 26 ),
				'Funding Failed' => array( 124 ),
				'High Risk' => array( 146 ),
				'Hotfile' => array( 154 ),
				//'In Conversion Queue' => array( 116 ), // CLK status
				//'In Process' => array( 17 ), // CLK status
				'In Review (F)' => array( 23, 24 ),
				'In Review (F) Follow Up' => array( 25 ),
				'In Review (HR)' => array( 147 ),
				'In Review (HR) Follow Up' => array( 149 ),
				'In Review (HR) Queued' => array( 148 ),
				'Inactive (Paid)' => array( 109 ),
				'Inactive (Recovered)' => array( 113 ),
				'Made Arrangements' => array( 125 ),
				//'Manager Conversion Queue' => array( 152, 151 ), // CLK status
				'Past Due' => array( 123 ),
				'Pending Approval' => array( 22 ),
				'Pending Expiration' => array( 155 ),
				//'Pending Transfer' => array( 114 ), // CLK status
				'Pre-Fund' => array( 121 ),
				'Prospect' => array( 100 ),
				'QC Arrangements' => array( 140 ),
				'QC Ready' => array( 135 ),
				'QC Returned' => array( 139 ),
				'QC Sent' => array( 136 ),
				'Quick Check' => array( 120 ),
				'Second Tier (Pending)' => array( 111 ),
				'Second Tier (Sent)' => array( 112 ),
				'Servicing' => array( 108 ),
				'Servicing Hold' => array( 122 ),
				'Skip Trace' => array( 157 ),
				'Soft Fax' => array( 156 ),
				'Underwriting' => array( 107 ),
				'Verification' => array( 106 ),
				'Withdrawn' => array( 19 ),
			);
			...
			{
				$pulldowndata['Pending'] = array(ECash::getFactory()->getReferenceList('ApplicationStatusFlat')->toId('pending::prospect::*root'));
				$pulldowndata['Prospect Confirmed'] = array(ECash::getFactory()->getReferenceList('ApplicationStatusFlat')->toId('confirmed::prospect::*root'));
				$pulldowndata['Confirm Declined'] = array(ECash::getFactory()->getReferenceList('ApplicationStatusFlat')->toId('confirm_declined::prospect::*root'));
				$pulldowndata['Declined'] = array(ECash::getFactory()->getReferenceList('ApplicationStatusFlat')->toId('declined::prospect::*root'));
				$pulldowndata['Disagree'] = array(ECash::getFactory()->getReferenceList('ApplicationStatusFlat')->toId('disagree::prospect::*root'));
				$pulldowndata['Prospect Confirmed (Preact)'] = array(ECash::getFactory()->getReferenceList('ApplicationStatusFlat')->toId('preact_confirmed::prospect::*root'));
				$pulldowndata['Pending (Preact)'] = array(ECash::getFactory()->getReferenceList('ApplicationStatusFlat')->toId('preact_pending::prospect::*root'));
			}

<html>
    ...
    <body style="background-color: #000000;">
        ...
        <?php
            ...
            if(empty(eCash_Config::getInstance()->DB_CACHE))
            {
                print("DB_CACHE configuraton not found");
            }
            elseif(FALSE === realpath(eCash_Config::getInstance()->DB_CACHE))
            {
                print(eCash_Config::getInstance()->DB_CACHE." not found");
            }
            else
            {
                $path = realpath(eCash_Config::getInstance()->DB_CACHE);

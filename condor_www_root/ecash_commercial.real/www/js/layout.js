...
//	date.setTime(Date.parse(document.getElementById('specific_date_display').value));
	...
	//		doc.write('<td align="left"><input id="credit_card_payments" value="0" /></td></tr>');
			...
			doc.write('<tr><td style="text-align: right">HMS Other Cost</td>');
...
function CheckDependencies(layout_id, group_id, layer_id, buttons)
{
	...
	var docs_match = /layout0group1layer[1234]/i;
...
function Is_First_Due_Date_Valid()
{
	...
	if (new_due_date == paydate_1 || new_due_date == paydate_2 ||
		 new_due_date == paydate_3 || new_due_date == paydate_4)
	{
		...
		{
			alert('The First Due Date must be at least ' + due_date_offset + ' days from the Fund Date.  DayDiff: ' + dayDiff);
		}
		else
		{
			result = true;
	...
	{
		alert('The First Due Date must fall on a paydate.');
	}
...
{
	var search_criteria = document.getElementById('search_criteria_1').value;
	...
	//mantis:4313
	if(document.getElementById('criteria_type_1').value == 'phone' && document.getElementById('search_deliminator_1').value != 'starts_with')
	{
		var phone1 = document.getElementById('search_criteria_1').value;
	...
	if(document.getElementById('criteria_type_2').value == 'phone' && document.getElementById('search_deliminator_2').value != 'starts_with')
	{
		var phone2 = document.getElementById('search_criteria_2').value;

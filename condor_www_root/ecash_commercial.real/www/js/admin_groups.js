...
/*
 */
function select_entire_tree()
{
	for (var a = 0; a < master_tree.length; a++)
	{
		document.getElementById(master_tree[a]['id']).checked = true;
		level_one = master_tree[a];
		level_two = level_one['sections'];
		for (b = 0; b < level_two.length; b++)
		{
			document.getElementById(level_two[b]['id']).checked = true;
			level_three = level_two[b]['sections'];
			for (var c = 0; c < level_three.length; c++)
			{
				document.getElementById(level_three[c]['id']).checked = true;
				level_four = level_three[c]['sections'];
				for (var d = 0; d < level_four.length; d++)
				{
					document.getElementById(level_four[d]['id']).checked = true;
				}
			}
		}
	}
...
/*
 */
function deselect_entire_tree()
{
	for (var a = 0; a < master_tree.length; a++)
	{
		document.getElementById(master_tree[a]['id']).checked = false;
		if(undefined != document.getElementById('read_only_'+master_tree[a]['id']))
		{
			document.getElementById('read_only_'+master_tree[a]['id']).checked = false;
		}
		level_one = master_tree[a];
		level_two = level_one['sections'];
		for (b = 0; b < level_two.length; b++)
		{
			document.getElementById(level_two[b]['id']).checked = false;
			if(undefined != document.getElementById('read_only_'+level_two[b]['id']))
			{
				document.getElementById('read_only_'+level_two[b]['id']).checked = false;
			}
			level_three = level_two[b]['sections'];
			for (var c = 0; c < level_three.length; c++)
			{
				document.getElementById(level_three[c]['id']).checked = false;
				if(undefined != document.getElementById('read_only_'+level_three[c]['id']))
				{
					document.getElementById('read_only_'+level_three[c]['id']).checked = false;
				}
				level_four = level_three[c]['sections'];
				for (var d = 0; d < level_four.length; d++)
				{
					document.getElementById(level_four[d]['id']).checked = false;
					if(undefined != document.getElementById('read_only_'+level_four[d]['id']))
					{
						document.getElementById('read_only_'+level_four[d]['id']).checked = false;
					}
				}
			}
		}

...
class Second_Tier
{
	...
	public function __construct ($server, $process_type)
	{
		...
		if($process_type)
		{
			require_once(LIB_DIR . "second_tier_" . $process_type . "_" . strtolower(eCash_Config::getInstance()->SECOND_TIER_FORMAT) . ".class.php");
			$class = "Second_Tier_" . ucfirst($process_type) . "_" . eCash_Config::getInstance()->SECOND_TIER_FORMAT;

...
class Landmark_ACH
{
	...
	private function formatPostData($batch_data)
	{
		 ...
		 */
		$company  = eCash_Config::getInstance()->LANDMARK_ACH_BATCH_COMPANY;
		$username = eCash_Config::getInstance()->LANDMARK_ACH_BATCH_USERNAME;
		$password = eCash_Config::getInstance()->LANDMARK_ACH_BATCH_PASSWORD;
	...
	{
		$url = eCash_Config::getInstance()->LANDMARK_ACH_BATCH_URL;
	...
	{
		require_once(LIB_DIR . "achtransport_ftp.class.php");
		require_once(LIB_DIR . "achtransport_sftp.class.php");
		require_once(LIB_DIR . "achtransport_https.class.php");

		$transport_type 	= eCash_Config::getInstance()->LANDMARK_ACH_RETURNS_TRANSPORT_TYPE;
		$hostname			= eCash_Config::getInstance()->LANDMARK_ACH_RETURNS_SERVER;
		$username	 		= eCash_Config::getInstance()->LANDMARK_ACH_RETURNS_USERNAME;
		$password	 		= eCash_Config::getInstance()->LANDMARK_ACH_RETURNS_PASSWORD;
		$remote_filename 	= eCash_Config::getInstance()->LANDMARK_ACH_RETURNS_FILENAME;

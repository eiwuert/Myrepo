			...
			$sql = '-- /* SQL LOCATED IN file=' . __FILE__ . ' line=' . __LINE__ . ' method=' . __METHOD__ . " */
					SELECT  ap.application_id,
		                    ...
		                    (
		                        ...
		                        WHERE   es.application_id = tr.application_id
		            ...
		            ) AS watch_affiliation ON (watch_affiliation.application_id = ap.application_id)
					WHERE   ap.company_id = {$this->company_id}

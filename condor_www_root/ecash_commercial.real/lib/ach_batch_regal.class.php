...
class ACH_Batch_Regal extends ACH_Batch
{
	...
	protected function Build_ACH_File($ach_transaction_ary)
	{
		...
		foreach ($ach_transaction_ary AS $record)
		{
			...
			$output['entry_type']					= ($record['ach_type'] == 'debit') ? 'TEL' : 'credit';
			...
			$output['merchant_id']					= isset(eCash_Config::getInstance()->MERCHANT_ID) ? eCash_Config::getInstance()->MERCHANT_ID : '';

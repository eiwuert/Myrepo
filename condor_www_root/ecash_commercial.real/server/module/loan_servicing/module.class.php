...
class Module extends Master_Module
{
	...
	const DEFAULT_MODE = 'customer_service';
	...
	public function __construct(Server $server, $request, $module_name)
	{
		...
		elseif (isset($_SESSION['loan_servicing_mode'])) 
		{
			...
			(
				...
				|| (preg_match("/close_out|review_batch|batch_history|send_batch|resend_batch/", $request->action))
			) 
			{
	...
	public function Main()
	{
		switch($this->request->action)
		{
			...
			case 'download_report':
				...
				$report->loadBy(array('sreport_id' => $this->request->report_id, 'sreport_type_id' => $report_type_id));

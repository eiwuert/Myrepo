...
class Applicant_Report_Query extends Base_Report_Query
{
	...
	public function Fetch_Company_Applicant_Data($date_start, $date_end, $loan_type, $company_id)
	{
		...
		$status_id_string = $this->status_ids['in_verify'] . ',' . $this->status_ids['in_underwriting'] . ',' . $this->status_ids['funded'] . ',' . $this->status_ids['approved'] . ',' . $this->status_ids['withdrawn'] . ',' . $this->status_ids['denied'] . ',' . $this->status_ids['reverified'];

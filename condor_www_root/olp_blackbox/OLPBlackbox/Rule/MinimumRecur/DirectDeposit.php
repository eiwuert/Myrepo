...
class OLPBlackbox_Rule_MinimumRecur_DirectDeposit extends OLPBlackbox_Rule_MinimumRecur
{
	 ...
	 * @param string $name_short the name of the target we're checking (not used in this function)
	 * @return int
	 */
	protected function runRecurCheck($data, DateTime $date, $name_short)
	{
		...
		if ($data->income_direct_deposit === FALSE || strcasecmp($data->income_direct_depost, 'FALSE') == 0)
		{
			return 0;
		}

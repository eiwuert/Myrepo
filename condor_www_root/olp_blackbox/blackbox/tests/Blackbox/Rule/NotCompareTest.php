...
/**
 * Unit tests for the Blackbox_Rule_NotCompare object
 * @author Matt Piper <matt.piper@sellingsource.com>
 */
class Blackbox_Rule_NotCompareTest extends PHPUnit_Framework_TestCase
{
	/**
	...
	public function testCompareTwoSame()
	{
		...
		$rule = new Blackbox_Rule_NotCompare();
	...
	public function testNotArrayDoesntExist()
	{
		...
		$rule = $this->getMock('Blackbox_Rule_NotCompare', array('onSkip'));
	...
	public function testNotArrayExists()
	{
		...
		$rule = $this->getMock('Blackbox_Rule_NotCompare', array('onError'));

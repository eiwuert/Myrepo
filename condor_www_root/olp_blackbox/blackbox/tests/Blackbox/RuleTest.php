 ...
 * @author Brian Feaver <brian.feaver@sellingsource.com>
 */
class Blackbox_RuleTest extends PHPUnit_Framework_TestCase
{
	/**
	...
	public function testIsValid()
	{
		...
		$rule = $this->getMock('Blackbox_Rule', array('runRule', 'canRun'));
	...
	public function testOnSkip()
	{
		...
		$rule = $this->getMock('Blackbox_Rule', array('onSkip', 'runRule'));
	...
	public function testOnValid()
	{
		...
		$rule = $this->getMock('Blackbox_Rule', array('canRun', 'onValid', 'runRule'));
	...
	public function testOnInvalid()
	{
		...
		$rule = $this->getMock('Blackbox_Rule', array('canRun', 'onInvalid', 'runRule'));
	...
	public function testOnError()
	{
		...
		$rule = $this->getMock('Blackbox_Rule', array('canRun', 'onERror', 'runRule'));
	...
	public function testExceptionOnlyCallsOnError()
	{
		...
		$rule = $this->getMock('Blackbox_Rule', array('canRun',

 ...
 * @group datax_tests
 */
class OLPBlackbox_Enterprise_Agean_Rule_DataXTest extends PHPUnit_Framework_TestCase
{
	/**
	 ...
	 * @return void
	 **/
	public static function isValidAgeanDataProvider()
	{
		return array(
			// This is a AGEAN_PERF call with an expected pass.
			array(
				OLPBlackbox_Enterprise_Agean_Rule_DataX::TYPE_AGEAN_PERF,
				'BB',
			...
			// This is a AGEAN_PERF call with an expected fail. (using DPB D9 bucket)
			array(
				OLPBlackbox_Enterprise_Agean_Rule_DataX::TYPE_AGEAN_PERF,
				'BB',
				OLPBlackbox_Config::MODE_BROKER,
			...
			// This is a AGEAN_PERF call with an expected fail. (using CRA D12 bucket)
			array( //Agean CRA/DPB-(Added)[MJ]
				OLPBlackbox_Enterprise_Agean_Rule_DataX::TYPE_AGEAN_PERF,
				'BB',
				OLPBlackbox_Config::MODE_BROKER,
				FALSE,
			...
			// This is a TYPE_AGEAN_TITLE call with an expected pass.
			array(
				OLPBlackbox_Enterprise_Agean_Rule_DataX::TYPE_AGEAN_TITLE, 
				'BB',
				OLPBlackbox_Config::MODE_BROKER,
				FALSE,
				'',
				'Agean_Title_Pass.xml',
				TRUE
				),
			// This is a TYPE_AGEAN_TITLE call with an expected fail.
			array(
				OLPBlackbox_Enterprise_Agean_Rule_DataX::TYPE_AGEAN_TITLE,
				'BB',
				OLPBlackbox_Config::MODE_BROKER,
	 ...
	 * 
	 * @dataProvider isValidAgeanDataProvider
	 * 
	 * @return void
	 */
	public function testIsValidAgean(
		$call_type,
		$account,
		$blackbox_mode,
		$allow_datax_rework,
		...
		$expected)
	{
		...
		$datax = $this->getMock(
			'OLPBlackbox_Enterprise_Agean_Rule_DataX', 
			array('initDataX', 'getHistory', 'initConfig', 'initAuthentication', 'hitStat', 'hitEvent'), 

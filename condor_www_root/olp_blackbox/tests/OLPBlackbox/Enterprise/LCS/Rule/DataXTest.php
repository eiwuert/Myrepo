 ...
 * Class taken directly from AALM as ony minor name changes were needed
 * GForge Ticket #9883
 *
 ...
 *
 */
class OLPBlackbox_Enterprise_LCS_Rule_DataXTest extends PHPUnit_Framework_TestCase
{
	/**
	 ...
	 * @return void
	 **/
	public static function isValidLCSDataProvider()
	{
		return array(
	 ...
	 * 
	 * @dataProvider isValidLCSDataProvider
	 * 
	 * @return void
	 */
	public function testIsValidLCS(
		$call_type,
		$account,
		$blackbox_mode,
		$allow_datax_rework,
		...
		$expected)
	{
		...
		// Mock the LCS DataX Rule
		$datax = $this->getMock(
			'OLPBlackbox_Enterprise_LCS_Rule_DataX', 

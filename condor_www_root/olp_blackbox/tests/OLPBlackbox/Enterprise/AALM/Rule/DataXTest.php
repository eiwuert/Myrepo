 ...
 * @group datax_tests
 */
class OLPBlackbox_Enterprise_AALM_Rule_DataXTest extends PHPUnit_Framework_TestCase
{
	/**
	 ...
	 * @return void
	 **/
	public static function isValidAALMDataProvider()
	{
		return array(
	 ...
	 * 
	 * @dataProvider isValidAALMDataProvider
	 * 
	 * @return void
	 */
	public function testIsValidAALM(
		$call_type,
		$account,
		$blackbox_mode,
		$allow_datax_rework,
		...
		$expected)
	{
		...
		$datax = $this->getMock(
			'OLPBlackbox_Enterprise_AALM_Rule_DataX', 

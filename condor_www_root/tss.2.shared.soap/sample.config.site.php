<?php
	...
	// name of the site
	define('SITE_URL', 'cashloansofamerica.com');
	define('SITE_NAME', 'CashLoansofAmerica.com');
	define('SITE_SKIN', 'cashloansofamerica.com');
	...
	function Get_Config($mode)
	{
		...
		$wsdl_file = dirname(__FILE__).'/wsdl/olp_'.strtolower($mode).'.wsdl';

	...
	protected function init()
 	{
		...
		$this->configVariables['ACH_BATCH_USE_PGP']          = FALSE; // They are *NOT* using encryption now
		...
		$this->configVariables['LIVE']['ACH_REPORT_LOGIN'] = 'M3X';
		$this->configVariables['LIVE']['ACH_REPORT_PASS'] = 'xRY843';
		...
		//LIVE SETTINGS
		$this->configVariables['LIVE']['IT_SETTLEMENT_TRANSPORT_TYPE'] = 'SFTP';
		$this->configVariables['LIVE']['IT_SETTLEMENT_URL'] = '/home/ncpfinance/it_settlement';
		$this->configVariables['LIVE']['IT_SETTLEMENT_LOGIN'] = 'ecashncp';
		$this->configVariables['LIVE']['IT_SETTLEMENT_PASS'] = '3eMUdruk';
		$this->configVariables['LIVE']['IT_SETTLEMENT_SERVER'] = 'drop1.sellingsource.com';
		$this->configVariables['LIVE']['IT_SETTLEMENT_SERVER_PORT'] = 22;
	
		$this->configVariables['LIVE']['ACH_REPORT_RETURNS_URL'] = '/returns/M3X'.date('md').'A.CSV';
		$this->configVariables['LIVE']['ACH_REPORT_CORRECTIONS_URL'] = '/returns/M3X'.date('md').'A.CSV';
		...
		$this->configVariables['RC']['COMPANY_SITE'] = 'http://rc.mycashcenter.com';
		$this->configVariables['LIVE']['COMPANY_SITE'] = 'http://www.mycashcenter.com';

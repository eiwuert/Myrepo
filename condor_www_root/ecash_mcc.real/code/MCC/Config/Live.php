	...
	protected function init()
 	{
		...
		$this->configVariables['API_DB_NAME'] = 'ldb_mcc';
		$this->configVariables['API_DB_USER'] = 'ecashmcc';
		$this->configVariables['API_DB_PASS'] = 'Gai9ahKa';
...
//		$this->configVariables['ACH_BATCH_URL'] = '/tranfile';
		...
		$this->configVariables['ACH_BATCH_SERVER'] = 'achtransport.achcommerce.com';
		$this->configVariables['ACH_BATCH_LOGIN']  = 'M3X';
		$this->configVariables['ACH_BATCH_PASS']   = 'xRY843';     
		$this->configVariables['ACH_BATCH_URL'] = '/tranfile';

		$this->configVariables['ACH_REPORT_LOGIN'] = 'M3X';
		$this->configVariables['ACH_REPORT_PASS'] = 'xRY843';

		$this->configVariables['ACH_REPORT_COMPANY_ID'] = '261605805';
		$this->configVariables['ACH_REPORT_RETURNS_URL'] = '/returns/M3X'.date('md').'A.CSV';
		$this->configVariables['ACH_REPORT_CORRECTIONS_URL'] = '/returns/M3X'.date('md').'A.CSV';

//		$this->configVariables['ACH_RECIPIENT'] = "transmissionteam@moneygram.com"; // NOT USED SINCE ENCRYPTION WAS DISABLED

		$this->configVariables['ACH_BATCH_NOTIFY_LIST'] = 'processing@moneygram.com,support@advantageach.com';

...
class eCash_Custom_RPC_CSO implements eCash_iWSDL
{
	...
	public function createRollover($application_id, $paydown_amount = 0)
	{
		...
		$response = $renewal_class->createRollover($application_id, $paydown_amount);
	...
	public function getRolloverEligible($application_id)
	{
		...
		$renewal_class = ECash::getFactory()->getRenewalClassByApplicationID($application_id);
		$response = $renewal_class->getRolloverEligibility($application_id);
	...
	public function getCSOFeeDescription($fee,$application_id,$company_id = null)
	{
		...
		{
			$renewal_class = ECash::getFactory()->getRenewalClassByLoanType($application_id,$company_id);
		}
		
		return $renewal_class->getCSOFeeDescription($fee,$application_id,$company_id);
	...
	{
		$renewal_class = ECash::getFactory()->getRenewalClassByApplicationID($application_id);
		return $renewal_class->getCSOFeeAmount($fee,$application_id);
	}

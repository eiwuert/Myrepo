...
//********************************************************
  ...
  function CuteEditor()
  {
    ...
    $this->AutoConfigure="Full_noform";
  ...
  { 
    ...
    {
      $s="<script language=\"JavaScript\" SRC=\"".$this->FilesPath."/Scripts/Constant.js\"></script><script language=\"JavaScript\" SRC=\"".$this->FilesPath."/license/CuteEditorPHPLic." .EXECUTION_MODE. ".js\"></script>";
    } 
    return $s;    
  } 

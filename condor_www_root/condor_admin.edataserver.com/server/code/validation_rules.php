...
// references
$rules->normalize->ref_01_name_full['type'] = "string";
$rules->normalize->ref_01_phone_home['type'] = "all_digits";
$rules->normalize->ref_01_relationship['type'] = "string";
$rules->normalize->ref_02_name_full['type'] = "string";
$rules->normalize->ref_02_phone_home['type'] = "all_digits";
$rules->normalize->ref_02_relationship['type'] = "string";
// legal
...
//reference
$rules->normalize->full_name['type'] = "cashline_string";
...
// references
$rules->validation->ref_01_name_full['type'] = "string";
$rules->validation->ref_01_name_full["min"] = 2;
$rules->validation->ref_01_name_full["max"] = 100;
$rules->validation->ref_01_phone_home['type'] = "phone_number";
$rules->validation->ref_01_phone_home["min"] = 10;
$rules->validation->ref_01_phone_home["max"] = 10;
$rules->validation->ref_01_relationship['type'] = "string";
$rules->validation->ref_01_relationship["min"] = 2;
$rules->validation->ref_01_relationship["max"] = 25;
$rules->validation->ref_02_name_full['type'] = "string";
$rules->validation->ref_02_name_full["min"] = 2;
$rules->validation->ref_02_name_full["max"] = 100;
$rules->validation->ref_02_phone_home['type'] = "phone_number";
$rules->validation->ref_02_phone_home["min"] = 10;
$rules->validation->ref_02_phone_home["max"] = 10;
$rules->validation->ref_02_relationship['type'] = "string";
$rules->validation->ref_02_relationship["min"] = 2;
$rules->validation->ref_02_relationship["max"] = 25;

	...
	public function Main()
	{
		...
		switch ($this->action)
		{
			case 'submit':
				...
				{
					$this->data->document->application_id = $this->request->app_id;
					$this->condor->Set_Application_id($this->data->document->document_id, $this->data->document->application_id);

	...
	public function Main()
	{
		...
		switch($this->request->action)
		{
			case 'detail':
				...
				{
					$this->data->filesystem_audits = $this->audit_report_query->Fetch_Failed_FS_Audits($this->request->execution_id);
				}
				break;
			case 'list':
			default:
				$this->data->reports = $this->audit_report_query->Fetch_FS_Report_List();
				break;
		}

...
// +----------------------------------------------------------------------+
//
// $Id: Server.php 3308 2005-05-17 18:03:45Z andrewm $
//
...
function SOAP_ServerErrorHandler($errno, $errmsg, $filename, $linenum, $vars) {
		...
		// if error messages are suppressed (via @),
		// don't fire a SOAP fault
...
*
* @access   public
* @version  $Id: Server.php 3308 2005-05-17 18:03:45Z andrewm $
* @package  SOAP::Client

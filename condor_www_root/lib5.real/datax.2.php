...
**/
require_once('/virtualhosts/lib/minixml/minixml.inc.php');
/** 
	...
	**/
	public function Datax_Call($call_type,$data,$mode,$property,$force = NULL,$call_type_override = NULL)
	{
		...
		else
		{
			...
			$this->call_object = new $call_obj($property,
			...
			return $this->call_object->makeRequest();
		}
	}
...
abstract class DataX_Call
{
	...
	**/	
	public function __construct($company,$key,$pass,$type,$data,$mode,$force=NULL)
	{
		...
		$this->xmlRoot = new DOMElement('DATAXINQUERY');
	...
	** and return the DataxResponse portion of the response
	** as an array.
	**/

...
class ECash_Models_FBODApplication extends ECash_Models_Application
{
	const RULE_NAME_PREFIX = 'FBOD Default Rule Set - ';
	
	public function __construct()
	{
		parent::__construct();
		//set these to overcome non-nullable fields unused by FBOD
		$this->is_react = 'no';
		$this->bank_name = '';
		$this->is_watched = 'no';

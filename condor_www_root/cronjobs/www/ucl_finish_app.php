<?php
	...
	// Build our db object
	$user_sql = new MySQL ("read1.iwaynetworks.net", "write1.iwaynetworks.net", "sellingsource", "%selling\$_db", "ucl_visitor", 3306, "\t".__FILE__." -> ".__LINE__."\n");
	$site_sql = new MySQL ("read2.iwaynetworks.net", "write2.iwaynetworks.net", "sellingsource", "%selling\$_db", "d2_management", 3306, "\t".__FILE__." -> ".__LINE__."\n");
...
//	$site_sql = new MySQL ("read2.dev04.tss", "write2.dev04.tss", "root", "", "d2_management", 3306, "\t".__FILE__." -> ".__LINE__."\n");
	...
	$query =
		...
		"from ".
			"site ";
	$site_info = $site_sql->Wrapper ($query, "site_id", "\t".__FILE__." -> ".__LINE__."\n");
	...
	foreach ($user_info as $user_data)
	{
		...
		$message_data->site=$site_info[$user_data->site_id];
		$message_data->site->return_url = $message_data->site->url . preg_replace ("/[^\/]*\$/", "", $user_data->request_uri);
	...
	mail ("pauls@sellingsource.com", "Finish App Stats - UCL", "Sent:\n".$counts."\nTook ".$process_time." seconds\n");
	mail ("johnh@sellingsource.com", "Finish App Stats - UCL", "Sent:\n".$counts."\nTook ".$process_time." seconds\n");
?>

<?php
	...
	else
	{
		...
		(
			"text" => "Your files have been uploaded to the ftp and are available for download. There were $records records from $today..."
		);

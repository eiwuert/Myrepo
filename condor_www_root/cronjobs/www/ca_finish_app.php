<?php
	...
	// Build our db object
	$user_sql = new MySQL ("read1.iwaynetworks.net", "write1.iwaynetworks.net", "sellingsource", "%selling\$_db", "ca_visitor", 3306, "\t".__FILE__." -> ".__LINE__."\n");
...
//	$site_sql = new MySQL ("read2.dev04.tss", "write2.dev04.tss", "root", "", "d2_management", 3306, "\t".__FILE__." -> ".__LINE__."\n");
	...
	$step4_body =
		...
		"\thttp://%%%site->return_url%%%/return_visitor.php?page=return_visitor&unique_id=%%%user->unique_id%%%\r\n\r\n".
	...
	mail ("pauls@sellingsource.com", "Finish App Stats - CA", "Sent:\n".$counts."\nTook ".$process_time." seconds\n");
	mail ("johnh@sellingsource.com", "Finish App Stats - CA", "Sent:\n".$counts."\nTook ".$process_time." seconds\n");
?>

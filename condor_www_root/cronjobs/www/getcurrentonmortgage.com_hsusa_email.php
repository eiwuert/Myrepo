...
$query= "SELECT * FROM getcurrentonmortgage where info_receiver like '%rjames@homesaversusa.com%' and created_date like '%".$day_start."%'";
...
$header = new StdClass ();
$header->subject = 'DMBuyers Mortgage Leads';
...
//$recipient1->address = 'rjames@homesaversusa.com';

<?php
        ...
        function teleweb_followup ($landing_page, $landing_page_id, $tw_promo_id="10000", $tw_promo_sub_code="")
        {
                ...
                // Initialize
                $start = date("Y-m-d H:i:s", strtotime("-2 hour"));
		...
		//echo $query;
                ...
                if ($sql->Row_Count ($lp_result) > 0)
                {
                        ...
                        while ($row = $sql->Fetch_Object_Row($lp_result))
                        {
                                ...
                                $tw_query = "
                                        SELECT
                                                landing_page_id as tw_landing_page_id, project_id as tw_project_id
                                        FROM
                                                landing_page
                                        WHERE
                                ...
                                if ($tw_row)
                                {
                                  ...
                                  $tw_project_id = $tw_row->tw_project_id;
                                }

                                $tw_query  = "INSERT INTO customer SET ";
                                // this will probably change:
                                $tw_query .= "project_id=" . $tw_project_id . ", ";
        ...
        //teleweb_followup ("https://trimpatch.com", 2);
        //teleweb_followup ("https://greatweboffers.com/sleepeze", 4);
        //teleweb_followup ("https://familyhs.com", 6);
        //teleweb_followup ("https://roadsideassurance.com", 7);
        //teleweb_followup ("https://boostex.com", 8);
        //teleweb_followup ("https://thevpatch.com", 9);

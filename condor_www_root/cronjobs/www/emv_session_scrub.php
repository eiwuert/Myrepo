<?php
	...
	$header = new StdClass ();
	$header->subject = 'emv_visitor session_site update ';
	...
	$message->text = "Daily emv_visitor session scrub ".$start_date. " and ". $end_date ."\r\n";
	...
	$mailing_id = $mail->CreateMailing ("emv session scrubber update", $header, NULL, NULL);

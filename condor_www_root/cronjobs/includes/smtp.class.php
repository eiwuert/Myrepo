...
***************************************/
	...
	class smtp{
        ...
        ***************************************/
		...
		function send($recipient, $message)
		{
			if($this->is_connected())
			{
				...
				// Transparency
				$headers = str_replace(CRLF.'.', CRLF.'..', trim($this->headers."To: ".$recipient."\r\n"));
				$body    = str_replace(CRLF.'.', CRLF.'..', $message);
        ...
        ***************************************/
		...
		function mail ()
		{
			if ($this->is_connected() && $this->send_data ("MAIL FROM:".$this->from) && substr (trim ($this->get_data ()), 0, 3) === "250")
			{
				return TRUE;
			}

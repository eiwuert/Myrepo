 ...
 */
abstract class Blackbox_Adapter
{
	/**
	...
	/**
	 * Puts Blackbox in a waking dream.
	 * 
	 * Stores the current winner and tier and picked
	 * targets so that on the next page, it can begin
	 * processing with all those in mind.
	 *
	 * @param bool $use_winner Whether to include the winner in the sleep state
	 * @return array Sleep data to store somewhere
	 * 		array(
	 * 			'exclude' => array('target1', 'target2'),
	 * 			'winner' => 'target3',
	 * 			'tier' => 2
	 * 		)
	 */
	public function sleep($use_winner = FALSE)
	{
		...
		if ($use_winner)
		{
			...
			$result['tier'] = $this->getWinnerTier();
		}

...
function list_available_admin_menu($user_acl_sub_names) {
	...
	//if (array_key_exists('privs', $user_acl_sub_names)) {
	...
	//	if (array_key_exists('groups', $user_acl_sub_names)) {
	...
	//if (array_key_exists('profiles', $user_acl_sub_names)) {
	...
	//if (array_key_exists('business_rules', $user_acl_sub_names)) {
	...
	//if (array_key_exists('holidays', $user_acl_sub_names)) {
	...
	if (isset($user_acl_sub_names['tags'])) 
	{
	...
	//if (array_key_exists('dda', $user_acl_sub_names)) {
	...
	//	if (array_key_exists('queue_config', $user_acl_sub_names)) {
	...
	//if (array_key_exists('docs_config', $user_acl_sub_names)) {
	if (isset($user_acl_sub_names['docs_config'])) 
	{
		...
		$available_items = list_available_admin_menu_merg_helper($available_items,
			array(
				'Document Manager' => array(
					...
					//	'Process Manager' => '/?mode=docs_config&view=process',
		...
		//if (array_key_exists('nada_import', $user_acl_sub_names)) {
...
function list_available_admin_menu_merg_helper($array1, $array2) {
	...
	foreach ($keys as $key) 
	{
		if ((isset($array1[$key]) && is_array($array1[$key])) || (isset($array2[$key]) && is_array($array2[$key]))) 
		{
			...
			if (!isset($array2[$key])) $array2[$key] = array();

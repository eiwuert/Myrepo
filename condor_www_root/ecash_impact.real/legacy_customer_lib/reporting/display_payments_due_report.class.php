	...
	*/
	public function Download_Data()
	{
		...
		if( $this->loan_type === true )
		{
			...
			{
				case 'all':
					echo "For loan types: All\n";
					break;
				case 'standard':
					echo "For loan type: Standard\n";
					break;
				case 'card':
					echo "For loan type: Card\n";
					break;
				default:
        ...
        if (mktime(0,0,0,$this->search_criteria['start_date_MM'], 
       	...
       	{
			echo "Date: " . $this->search_criteria['start_date_MM']   . "/"
		                  . $this->search_criteria['start_date_DD']   . "/"
          		          . $this->search_criteria['start_date_YYYY'] . "\n";
		}
		else
		...
		foreach( $this->search_results as $company_name => $company_data )
		{
			...
			echo $this->Get_Company_Foot($company_name, false);
		}

		if( $this->num_companies > 0 )
			echo $this->Get_Report_Foot( false );
	}

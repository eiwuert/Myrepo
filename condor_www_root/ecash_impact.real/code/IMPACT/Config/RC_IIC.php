 ...
 */
class IMPACT_Config_RC_IIC extends IMPACT_Config_Base
{
	protected function init()
 	{
		 ...
		 */
		$this->configVariables['mode'] =  'iic_rc';
		 ...
		 */
		if (!defined('QC_RETURN_FILE_DIR')) define('QC_RETURN_FILE_DIR', '/var/quickchecks/ecash3.0/iic/rc/');

 ...
 */
class IMPACT_Config_Live_IIC extends IMPACT_Config_Base
{
	protected function init()
 	{
		 ...
		 */		
		$this->configVariables['mode'] =  'iic_live';
		 ...
		 */
		$this->configVariables['DB_HOST'] = 'writer.intacash.ept.tss';
		$this->configVariables['DB_NAME'] = 'ldb_intacash';
		$this->configVariables['DB_USER'] = 'ecash_intacash';
		$this->configVariables['DB_PASS'] = 'at4aeDul';
		$this->configVariables['DB_PORT'] = 3307;
		
		$this->configVariables['SLAVE_DB_HOST'] = 'reporting.intacash.ept.tss';
		$this->configVariables['SLAVE_DB_NAME'] = 'ldb_intacash';
		$this->configVariables['SLAVE_DB_USER'] = 'ecash_intacash';
		$this->configVariables['SLAVE_DB_PASS'] = 'at4aeDul';
		$this->configVariables['SLAVE_DB_PORT'] = 3310;
		
		$this->configVariables['API_DB_HOST'] = 'reader.ecashimpactolp.ept.tss';
		$this->configVariables['API_DB_NAME'] = 'ldb_intacash';
		$this->configVariables['API_DB_USER'] = 'ecash_intacash';
		$this->configVariables['API_DB_PASS'] = 'at4aeDul';
		...
		$this->configVariables['FORCE_SSL_LOGIN'] = 'ON';
 		...
 		$this->configVariables['MASTER_DOMAIN'] = 'master.live.ecash.impactintacash.com';
		$this->configVariables['LOAD_BALANCED_DOMAIN'] = 'master.live.ecash.impactintacash.com';
		$this->configVariables['COOKIE_DOMAIN'] = '.impactintacash.com';
		 ...
		 */
		$this->configVariables['NOTIFICATION_ERROR_RECIPIENTS'] = 'brian.ronald@sellingsource.com, brronald@gmail.com, ben.burkhart@sellingsource.com, richard.bunce@sellingsource.com';
		$this->configVariables['ECASH_NOTIFICATION_ERROR_RECIPIENTS'] = 'brian.ronald@sellingsource.com, brronald@gmail.com, ben.burkhart@sellingsource.com, richard.bunce@sellingsource.com';

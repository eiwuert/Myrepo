 ...
 */
class IMPACT_Config_Local_IIC extends IMPACT_Config_Base
{
	protected function init()
 	{
		 ...
		 */
		$this->configVariables['mode'] =  'iic_local';
		 ...
		 */
		$this->configVariables['DB_HOST'] = 'monster.tss';
		$this->configVariables['DB_NAME'] = 'ldb_intacash';
		$this->configVariables['DB_USER'] = 'ecash';
		$this->configVariables['DB_PASS'] = 'lacosanostra';
		$this->configVariables['DB_PORT'] = 3309;

		$this->configVariables['SLAVE_DB_HOST'] = 'monster.tss';
		...
		$this->configVariables['SLAVE_DB_PORT'] = 3309;

		$this->configVariables['API_DB_HOST'] = 'monster.tss';
		...
		$this->configVariables['API_DB_PORT'] = 3309;

...
/**
	...
	@version
		...
		1.5.1 2006-06-12 - Brian Feaver
			- [feature] Added eCash 3.0 react rules for calculating the react loan amount.

		1.5.0 2005-09-16 - Raymond Lopez
			- [feature] MySQLi Connection Update
			- [feature] Business Rule Config
			- [feature] Calculate_React_Loan_Amount for new Business Rules
    ...
    */
			...
			$frequency_name = NULL) //mantis:9786 - added $frequency_name
	{
		...
		else
		{
			...
			{
				$fund_amount = ($fund_amount > $react_amounts_ecash[$frequency_name]) ? $react_amounts_ecash[$frequency_name] : $fund_amount;
			}
			else
			{
    ...
    /**
    	...
    	@return $fund_amount string Fund Amount
    */
	public function Calculate_Loan_Amount($monthly_net, $direct_deposit=NULL)
	{
		$fund_amount = NULL;
    ...
    */
	...
	/**
		@privatecsection
               @protected
               @brief
                       Get what type of loan to get a loan type for.  This exists for overriding in custom subclasses.

               @return $loan_type string property_short;
    */

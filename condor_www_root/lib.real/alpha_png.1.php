...
/*
	@version
			1.0.0 2005-04-07 - David Bryant

	Updates:
	-04/07	A class for cross-browser use of alpha-channel transparency in PNG files to be used
	...
	*/
	function img ($png_file, $string_flag=false, $size_str=false)
	{
		...
		if ($this->ie)
		{
			...
			$this->img = "<img src=\"".$this->img_dir."/spacer.gif\" ".$img_info." style=\"filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='".$this->img_dir."/".$png_file."',sizingMethod='scale');\" alt=\"\">";
		}
		else
		{

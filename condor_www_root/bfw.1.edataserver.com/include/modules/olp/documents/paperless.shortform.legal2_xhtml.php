<?php
	...
	elseif( $_SESSION["config"]->property_short == "USF" )
	{
	...
	"\n<p>".
	"\nYou have agreed to the terms of your <strong><a href=\"javascript:void(0)\" onclick=\"pop_newsite('?page=preview_docs&unique_id=@@unique_id@@', 'loan_note_and_disclosure');\">LOAN NOTE AND DISCLOSURE</a></strong> and wish for us to send you ".
	"your cash. You may now confirm this by reviewing the documents and terms below, and eSigning your loan documents. Once you eSign, you have agreed to receive and repay your loan according to the terms described.". 
	"\n<span style=\"font-weight:bold; color:#FF0000; text-decoration:underline;\">You are agreeing to have your loan processed without further communication or action on either party?s part.</span>".
	"\n</p>".

...
/** A wrapper class for libolution's Stats_StatPro_Client_1 stat client.
 * Stolen from the new BFW project.
 *
...
class OLPStats
{
	...
	/** Returns the underlying instance of Stats_StatPro_Client_1.
	 *
	...
	{
		return $this->getStatPro()->getSpaceKey($space_definition);
	}

<?php
	 ...
	 * requesting you to upgrade your php version to a later version of PHP5.
	 * 
	 * Requirements of a fully implemented Nirvana_Client:
	 * 
	 *   1) implement the abstract method Fetch_Multiple(array $track_keys)
	 *      this function should access your database to retrieve user information
	 *      for any track_key belonging to your implementation.
	...
	class Nirvana_Mine extends Nirvana_Client 
	{
		 ...
		 * @return array
		 */
		public final function Fetch_Multiple(array $track_keys)
		{
			$return_data = array();

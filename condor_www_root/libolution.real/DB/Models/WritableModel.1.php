<?php
	...
	require_once('libolution/DB/Util.1.php');
	 ...
	 */
	abstract class DB_Models_WritableModel_1 extends DB_Models_DatabaseModel_1
	{
		/**
		 ...
		 * @return string
		 */
		public abstract function getAutoIncrement();
		...
		public function insert()
		{
			...
			{
				throw new Exception("Insufficient data supplied for primary key.");
			}
		...
		public function loadBy(array $where_args)
		{
			...
			if (($row = DB_Util_1::querySingleRow($db, $query, $where_args)) !== FALSE)
			{
				$this->fromDbRow($row);
				return TRUE;
			}

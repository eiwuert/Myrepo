...
class ABA_1
{
	const DATAX_URL = 'https://verihub.com/datax/aba.php';

	/** DataX license key (BlackBox). */
	const DATAX_LICENSE = 'fbe0044486e20d84f67c795619242adc';

	/** DataX password (BlackBox). */
	const DATAX_PASSWORD = '9cb5917a3dca';

	/** DataX RC URL. */
	//const DATAX_URL = 'http://verihub.com/rcdatax/aba.php';

	/** DataX local URL. */
	//const DATAX_URL = 'http://dataxv2.ds62.tss/';
	 ...
	 * @var string
	 */
	protected $datax_license;

	/**
	 * @var string
	 */
	protected $datax_password;
	
	/**
	 * Constructs a new <code>ABA_1</code>.
	 * @param string $datax_url
	 * @param string $datax_license
	 * @param string $datax_password
	 */
	function ABA_1($datax_url = self::DATAX_URL, $datax_license = self::DATAX_LICENSE, $datax_password = self::DATAX_PASSWORD)
	{
		$this->datax_url = $datax_url;
		$this->datax_license = $datax_license;
		$this->datax_password = $datax_password;
	}
	...
	function Info ($routing_number, $field_list)
	{
		$req = "<?xml version=\"1.0\" encoding=\"iso-8859-1\"?>
				<DATAXINQUERY>
					<AUTHENTICATION>
						<LICENSEKEY>" . $this->datax_license . "</LICENSEKEY>
						<PASSWORD>" . $this->datax_password . "</PASSWORD>
					</AUTHENTICATION>
					<QUERY>
						<TYPE>aba-l2</TYPE>
						<DATA>

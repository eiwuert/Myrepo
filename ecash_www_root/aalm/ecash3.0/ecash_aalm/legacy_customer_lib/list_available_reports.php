		...
		'agent_reports' => array(
			...
			'reports' => array(
				...
				'agent_internal_recovery' => array(
											'name' 	=> 'Payments Recovered By CSR',
				...
				'follow_up' => array(
											...
											'desc'	=> Gen_Report_Desc("To view all of the follow ups.",
														array(	"Start Date", "End Date", "Company"),
														array(	"Originator","Sent to","App ID",
															"App Status","Customer","Comment",
															"Follow Up Type","Created On",
															"Follow Up Time",'Follow Up Status'))
									),
				'agent_comments' => array(
											'name' 	=> 'Agent Comments',
											'link'  => '/?module=reporting&mode=agent_comments',
											'desc'	=> Gen_Report_Desc("To view all of the agent comments.",
														array(	"Start Date","End Date","Comment Flag","Company"),
														array(	"App ID","Customer","App Status","Agent","Created On",
															"Comment Type","Comment Flag","Comment"))
									),
				'call_dispositions' => array(
											'name'  => 'Call Dispositions',
											'link'  => '/?module=reporting&mode=call_dispositions',
											'desc'  => Gen_Report_Desc("To view all of the call dispositions.",
														array(  "Start Date","End Date","Flag","Company"),
														array(  "App ID","Customer","App Status","Agent",
															"Created On","Flag","Call","Loan Action"))
									),
				'fraud' => array(
				...
				'payment_arrangements' => array(
                                ...
                                //asm 33
                                'agent_affiliation' => array(
											'name' 	=> 'Agent Affiliation',
											'link'  => '/?module=reporting&mode=agent_affiliation',
											'desc'	=> Gen_Report_Desc("To review arrangement, partial, and manual payments.",
														array(	"Start Date", "End Date","Collection Level","Date Search","Company",),
														array(	"Company","Agent Name","Application ID",
                                                                                                                                "App Status Before Payment","Current App Status","Customer Name",
                                                                                                                                "ES ID","Created Date","Context",
                                                                                                                                "Payment Type","Amount","Principal","Interest/Fees",
																"Effective Date","Schedule Status","Payment Status"))
									),
				...
				'agent_email_queue' => array(
											'name' 	=> 'Emails - Incomming',
											'link'  => '/?module=reporting&mode=agent_email_queue',
											'desc'	=> Gen_Report_Desc("To view incomming email queue actions.",
														array(	"Start Date", "End Date", "Agent","Company",),
														array(	'Agent','Opened','Associated',
 				                                                'Responded','Follow Ups','Filed',
				                                                'Queue Change','Canned Responses','Removed',
										'Recieved','Service Level','Reply Rate','File Rate'))
									),
				'agent_email_output' => array(
											'name' 	=> 'Emails - Outgoing',
											'link'  => '/?module=reporting&mode=agent_email_output',
											'desc'	=> Gen_Report_Desc("To view outgoing email queue actions.",
														array(	"Start Date", "End Date", "Agent","Company",),
														array(	'Agent','Sent','Documents'))
									),
		...
		'applicant_reports' => array(
			...
			'accounts_recievable' => array(
				...
				'payments_due' => array(
											...
											'desc'	=> Gen_Report_Desc("To view all payments due on a given date.",
														array(	"Start Date","End Date","Loan Type","Company"),
				...
				'loanactions' => array(
											'name' 	=> 'Loan Actions',
											'link'  => '/?module=reporting&mode=loanactions',
											'desc'	=> Gen_Report_Desc("Shows how many applicants went through the loan process.",
														array(	"Start Date","End Date","Company"),
														array(	"Application ID", "New/React", "First Name", "Last Name",
														      "Home Phone", "Cell Phone", "Work Phone", "Email", "Application Status",
														      "Application Date", "Fund Date", "Date of Loan Action", "Loan Action Description",
														      "Comment", "Agent Name", "Monthly Income", "income Type", "Direct Deposit", 
														      "Employer Name", "Income Frequency", "Week 1", "Week 2", "Day of Week",
														      "Day of Month 1", "Day of Month 2", "Campagn", "Promo ID"))
									),			
...
//									),	
				...
				'reactivation_marketing' => array(
											'name' 	=> 'Customer Marketing Report',
		...
		'batch_reports' => array(
			...
			'reports' => array(
				'achbatch' => array(
											...
											'desc'	=> Gen_Report_Desc("Displays Batch report for a date range.",
														array(	"Date Range"),
														array( 'Date','# Credits','$ Credits', '# Debits','$ Debits','# Net','$ Net', '# Returned','$ Returned', '$ Net after returns', '# Unauthorized Returns',
																 '$ Unauthorized Returns', 'ACH / Card'))
									),
				'achbatch_detail' => array(
											'name' 	=> 'Batch Detail',
											'link'  => '/?module=reporting&mode=achbatch_detail',
											'desc'	=> Gen_Report_Desc("Displays individual Batch records for a date range.",
														array(	"Date Range"),
													    array( 'Date',  'Batch ID', 'Batch Date', 'Application ID',
															  'First Name', 'Last Name', 'ABA #', 'Status',
															  'Amount', 'Return Code', 'Return Date', 'ACH / Card' ) )
									),
				'batch_review' => array(
											'name' 	=> 'Batch Review',
		...
		'overview_reports' => array(
			...
			'reports' => array(
				...
				'portfolio_snapshot' => array(
											...
											'link'  => '/?module=reporting&mode=portfolio_snapshot',
											'desc'	=> Gen_Report_Desc("Displays the portfolio snapshot nightly report run on a given day.",
														array(	"Date" ),
																	   array( "Company", "Application ID", "Name",
																			  "Status", "Balance", "Payments",   ))
									),

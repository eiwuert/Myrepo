...
/**
 * Information about the Clarity request made, and the response
 *
 * @author Andrew Minerd <andrew.minerd@sellingsource.com>
 */
class Clarity_UW_Result
{
	/**
	 * @var string
	 */
	 ...
	 * @param Clarity_UW_IResponse $response Response parser
	 */
	public function __construct($call_type, $elapsed, $request_xml, $response_xml, Clarity_UW_IResponse $response = NULL)
	{
		$this->type = $call_type;

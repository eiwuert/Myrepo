...
//					Never before funding date
			...
			if( $this->batch_type === true ) {
				$substitutions->react_type_select_list = '<span>Batch Type: </span><span><select name="batch_type" size="1" style="width:50px;"></span>';
				switch( $this->search_criteria['batch_type']) {
					case '':
						$substitutions->react_type_select_list .= '<option value="" selected>All</option>';
						$substitutions->react_type_select_list .= '<option value="ach">Ach</option>';
						$substitutions->react_type_select_list .= '<option value="card">Card</option>';
					break;
				
					case 'ach':
						$substitutions->react_type_select_list .= '<option value="">All</option>';
						$substitutions->react_type_select_list .= '<option value="ach" selected>Ach</option>';
						$substitutions->react_type_select_list .= '<option value="card">Card</option>';
					break;
					...
					case 'card':
						$substitutions->react_type_select_list .= '<option value="">All</option>';
						$substitutions->react_type_select_list .= '<option value="ach">Ach</option>';
						$substitutions->react_type_select_list .= '<option value="card" selected>Card</option>';
					break;

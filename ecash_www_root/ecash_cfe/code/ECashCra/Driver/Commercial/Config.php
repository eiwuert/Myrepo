...
class ECashCra_Driver_Commercial_Config
{
	...
	{
		return array(
			'generic'   => new DB_MySQLConfig_1('writer.mysql.loanservicecompany.com', 'username', 'password', 'database'),
		);
	}
	...
	protected function setupCompanyCredentials()
	{
		return array(
				"generic" => array(
						'TSS' => array('url' => 'https://cra.verihub.com/', 'username'=>'username' ,'password'=>'password'),
				)
		);
	}

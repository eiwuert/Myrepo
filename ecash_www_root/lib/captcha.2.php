<?php
	...
	class Captcha_2
	{
		...
		public function __construct($display_string = NULL)
		{
			...
			// include path will likely have lib in it, but just in case...
			$this->font = realpath(dirname(__FILE__) . '/' . $this->font);
		}
		...
		function Display($output_type = self::OUTPUT_PNG)
		{
			...
			// draw the border
			$border_color = ($this->border_color !== NULL) ? $this->Color($this->border_color) : 0;

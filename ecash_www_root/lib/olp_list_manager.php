	...
	*/
	...
	{	
		...
		//require_once("/virtualhosts/site_config/server.cfg.php");
			...
			$query = "INSERT INTO data (application_id, first, last, email, segmentcode, ip_address, address, city, state, zip, phone, datran_group, phone_cell, phone_work, unbanked, dob, promo_id, bb_vendor_bypass, tier, target, sold_to_amg, data_provider) ".

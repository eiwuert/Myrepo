<?php
	// Version 1.0.0
	// that line is for (IMO, lame) library loader backward compatibility
...
class LDAP_1
{
	...
	/**
		@publicsection
		@public
		@fn boolean LDAP_1($server, $bind_cn, $bind_pw)
		@brief boolean LDAP_1(string server, string bind_cn, string bind_pw)
        @param string server \n ldap server name
	...
	*/
	function LDAP_1($server, $bind_cn, $bind_pw)
	{

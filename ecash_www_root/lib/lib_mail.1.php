		...
		*/
		function _Send_Mail ($header, $recipient_array, $message, $call_count = 0)
		{
			...
			if (is_numeric ($mailing_id) && $mailing_id > 0)
			{
				...
				{
					mail ("rebel75cell@gmail.com", "Error in ".__FILE__.":".__LINE__, "Adding package failed!\n\n".var_export ($package_id, 1));
					return FALSE;
				}
				else
				{
			...
			elseif ($call_count < 3)
			{
				mail ("rebel75cell@gmail.com", "Error in ".__FILE__.":".__LINE__, "Create Mailing Failed!\n\n".var_export ($mailing_id, 1));

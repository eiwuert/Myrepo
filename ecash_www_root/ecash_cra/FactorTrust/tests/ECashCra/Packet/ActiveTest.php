...
class ECashCra_Packet_ActiveTest extends PHPUnit_Framework_TestCase
{
	/**
	...
	public function setUp()
	{
		...
		$this->base = new ECashCra_Packet_Active($this->application->getApplication());
	}

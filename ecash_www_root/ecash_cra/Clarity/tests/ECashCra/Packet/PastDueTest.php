...
class ECashCra_Packet_PastDueTest extends PHPUnit_Framework_TestCase
{
	/**
	...
	public function setUp()
	{
		...
		$this->base = new ECashCra_Packet_PastDue($this->application->getApplication(), '2008-03-21');
	}
	...
	public function testGetXml()
	{
		...
		$expected->QUERY->TYPE = 'past_due';
		$data_element = $expected->QUERY->DATA;
		$data_element->addChild('PASTDUEDATE', '2008-03-21');
